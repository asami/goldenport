...
class ExcelSheetEntity(sheet: HSSFSheet, val book: ExcelBookEntity,
  ...
  def this(sheet: HSSFSheet, book: ExcelBookEntity, aContext: GEntityContext) = this(sheet, book, null, aContext)

  def this(book: ExcelBookEntity, aContext: GEntityContext) = this(book, null, aContext)
